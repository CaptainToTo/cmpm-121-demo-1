...
export class UpgradeFactory {
  static buildBlender(): Upgrade {
    return Upgrade.buildUpgrade("Blender")
  ...
  static buildBiggerCups(): Upgrade {
    return Upgrade.buildUpgrade("Bigger Cups")
  ...
  static buildEmployees(): Upgrade {
    return Upgrade.buildUpgrade("Employees")
  ...
  static buildInvestments(): Upgrade {
    return Upgrade.buildUpgrade("Off Shore Investments?")
  ...
  static buildUnionBusting(): Upgrade {
    return Upgrade.buildUpgrade("Union Busting Campaign")
